            ...
            <div className="items">
              ...
              <div className="details">
                ...
                <div className="detailItem">
                  ...
                  <span className="itemValue">+92 1321321</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Address:</span>
                  <span className="itemValue">GUlshane Iqbal street No 2</span>
                </div>
                <div className="detailItem">
